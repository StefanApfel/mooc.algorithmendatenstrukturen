...
namespace StefanApfel.Learning.AlgorithemDataStructures.Arrays
{
  ...
  /// auszugeben.</summary>
  // ===================================================================================================
  public sealed class Suche : IConsoleMenuCommand
  {
    // -------------------------------------------------------------------------------------------------
    ...
    public String Name
    {
      get { return "Lineare & Binäre Suche"; }
    }
    ...
    // -------------------------------------------------------------------------------------------------
    private void FindValueLinear(Int32[] values, Int32 value)
    {
    ...
    // -------------------------------------------------------------------------------------------------
    private void FindValueBinary(Int32[] values, Int32 value)
    {
      // Sortiere das Array...
      SortValues(values);
    ...
    /// <param name="values">Das Werte Array.</param>
    // -------------------------------------------------------------------------------------------------
    private void SortValues(Int32[] values)
    {
      IO.PrintLine("\nSortiere Array...");
      Array.Sort(values);
